...
// Used in CMPM 121 Final, edited file is found here: https://github.com/josephrocca/clip-image-sorter/blob/main/enable-threads.js
if(typeof window === 'undefined') {
  ...
  async function handleFetch(request) {
    ...
    headers.set("Cross-Origin-Embedder-Policy", "require-corp"); // or: credentialess
